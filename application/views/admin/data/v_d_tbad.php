        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">TBAD</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class="project-actions text-right">
                          <a class="btn btn-info btn-sm" href="<?php echo site_url('c_admin/edit_tbad/'.$u->id_bad);?>">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Ubah
                          </a>
                          
                          <a class="btn btn-danger btn-sm" href="<?php echo site_url('c_admin/hapus_badlb/'.$u->id_bad);?>">
        ...
        <div class="modal-dialog">
          <div class="modal-content bg-primary">
            <div class="modal-header">
              <h4 class="modal-title">INSERT TBAD</h4>
...
ksks-->
            <div class="modal-body">
             <form action="<?php echo site_url('c_admin/simpan_tbad')?>" method="POST">
                <div class="card-body">
