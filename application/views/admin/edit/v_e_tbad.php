        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="<?php echo site_url('c_admin/c_d_tbad')?>">TBAD</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card card-primary">
              ...
              <form action="<?php echo site_url('c_admin/update_tbad')?>" method="post">
                 <div class="card-body">

                  <div class="form-group">
                    <label for="exampleInputEmail1">ID BAD LB</label>
                    <input type="text" class="form-control" value="<?php echo $u->id_bad ?>" id="badlb" placeholder="TBAD" name="id_bad" readonly>
                  </div>
